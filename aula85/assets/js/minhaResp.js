// //Minha tentativa de fazer o exercicio sem ver a resposta do professor
...
//         const validatUser = this.user.match(/^[a-zA-Z0-9]+$/g);
...
//         //Valida a senha
//         //Erro no .length !!
//         if (!this.password || !this.repetPassword) return alert('senha nao definida');
//         if (this.password.length < 6 || this.password.length > 12) return alert('senha deve ter de 6 a 12 digitos');
//         if (this.repetPassword.length < 6 || this.repetPassword.length > 12) return alert('repetir senha deve conter de 6 a 12 caraceteres');
