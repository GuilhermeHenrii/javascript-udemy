...
/* harmony export */   age: () => (/* binding */ idade),
/* harmony export */   calculaIdade: () => (/* binding */ calculaIdade),
...
function soma(x, y) {
 ...
 //aqui estamos exportando a constante nome. Note que usei o AS para expotar a variável idade passando um 'apelido' age
...
//Import e Export: com import e export resolvemos isso. Como o nome já diz, podemos importar e exportar coisas entre arquivos em um módulo
 ...
 //aqui estamos importando as constantes nome,sobrenome, idade, além da função soma de um outro arquivo

var nome = 'joao'; //aqui daria um erro, pois a variável nome já havia sido declarada, porém, usando o AS podemos importar a variável já alterando seu nome

console.log(nome, _modulo1__WEBPACK_IMPORTED_MODULE_0__.nome, _modulo1__WEBPACK_IMPORTED_MODULE_0__.sobrenome, _modulo1__WEBPACK_IMPORTED_MODULE_0__.age);
console.log((0,_modulo1__WEBPACK_IMPORTED_MODULE_0__.soma)(5, 10));
var p1 = new _modulo1__WEBPACK_IMPORTED_MODULE_0__.Pessoa('gui', 'henri');
console.log(p1);
